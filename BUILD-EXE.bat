...
echo ============================================================
echo RadioBOSS Studio Monitor v1.0.12 - Public Windows Build
echo ============================================================
echo.
...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  "Compress-Archive -Path '%~dp0release-package\*' -DestinationPath '%~dp0RadioBOSS-Studio-Monitor-v1.0.12-Windows.zip' -Force"
if errorlevel 1 goto :failed
...
echo ZIP: %~dp0RadioBOSS-Studio-Monitor-v1.0.12-Windows.zip
echo.
